...
<span class="community-label">EMERGING FUTURE COMMUNITY</span>
<h3>学び合い、創造する<br>コミュニティへ</h3>
</div>
<div class="community-quote">「未来の理解はコモンズである」── 未来に対するアプローチや、そこで得られた情報は共通の財産です。</div>
<div class="community-lead">AIとの協働で「まだ形になっていない未来」を作る。<br>その実践を、学び合いながら進める場です。</div>
...
<div class="com-trust">マニュアル更新・実践事例・AI協働の最新動向をお届けします</div>
</div>
...
<button class="com-btn com-btn-primary" onclick="submitCommunity()" id="comSubmit">コミュニティに参加する</button>
</div>
</div>
...
<div class="community-quote">想像（Imagination）の中で起こる創造（Creation）── 作る行為そのものが想像を触発し、想像が新たな創造を呼ぶ。</div>
<div class="community-lead">はずみ車は、一人で回すより一緒に回すほうが速い。<br>実践者たちと学び合うコミュニティに参加しませんか。</div>
<div class="community-divider"></div>
...
<button class="com-btn com-btn-primary" onclick="submitCommunity2()" id="comSubmit2">コミュニティに参加する</button>
</div>
</div>
