...
<div class="concept-cards"><div class="concept-card" style="border-left:3px solid #2060c0"><div class="icon">&#128193;</div><div class="title">GitHub</div><div class="body">コードの倉庫。パソコンが壊れてもファイルが残る</div></div><div class="concept-card" style="border-left:3px solid #208020"><div class="icon">&#127760;</div><div class="title">Vercel</div><div class="body">公開の窓口。URLを発行してくれる</div></div><div class="concept-card" style="border-left:3px solid var(--accent)"><div class="icon">&#129504;</div><div class="title">Anthropic</div><div class="body">AIの頭脳。アプリにAI機能をつけるための鍵</div></div></div>
...
Cursorは、Claude Codeを使うためのアプリです。ChatGPTのようなチャット画面があり、そこにやりたいことを日本語で入力すると、AIがファイルを作成・編集してくれます。
...
<div class="diagram"><div class="diagram-title">どのデータベースを使う？</div><div class="diagram-body"><div class="decision"><div class="decision-q">アプリを自分のPCだけで使う？</div><div class="decision-branches"><div class="decision-branch" style="background:#f0f6ff"><div class="label">はい</div><div class="answer">SQLite</div><div class="detail">設定不要。ファイル1つで動く</div></div><div class="decision-branch"><div class="label">いいえ（公開する）</div><div class="answer">&#8595; 次の質問へ</div><div class="detail"></div></div></div></div><div class="decision"><div class="decision-q">ユーザーのログイン機能が必要？</div><div class="decision-branches"><div class="decision-branch" style="background:#f0fdf0"><div class="label">はい</div><div class="answer">Supabase</div><div class="detail">ログイン機能が最初から付いている</div></div><div class="decision-branch"><div class="label">いいえ</div><div class="answer">&#8595; 次の質問へ</div><div class="detail"></div></div></div></div><div class="decision"><div class="decision-q">データがリアルタイムで更新される？</div><div class="decision-branches"><div class="decision-branch" style="background:#fff8f0"><div class="label">はい</div><div class="answer">Firebase</div><div class="detail">画面を開いたまま最新データが反映</div></div><div class="decision-branch" style="background:#f0fdf0"><div class="label">いいえ</div><div class="answer">Turso</div><div class="detail">無料枠が大きく設定も簡単</div></div></div></div></div></div></div>
...
**アカウント作成:**
1. ブラウザで \`console.firebase.google.com\` にアクセス
2. Googleアカウントでログイン
3. 「プロジェクトを追加」をクリック
4. プロジェクト名を入力
...
**取得方法:**
1. \`console.cloud.google.com\` にアクセス（Googleアカウントでログイン）
2. 「新しいプロジェクト」を作成
...
**取得方法:**
1. \`marketplace.zoom.us\` にアクセス（Zoomアカウントでログイン）
2. 「Develop」→「Build App」
...
**取得方法:**
1. \`disclosure2dl.edinet-fsa.go.jp\` にアクセス
