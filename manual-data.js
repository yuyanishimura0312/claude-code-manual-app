...
<h3>学び合い、創造するコミュニティへ</h3>
<div class="community-quote">「未来の理解はコモンズである」── 未来に対するアプローチや、そこで得られた情報は共通の財産です。</div>
<div class="community-lead">AIとの協働で「まだ形になっていない未来」を作る。その実践を一人で行うのではなく、学び合いながら進める場を用意しました。マニュアルの更新情報、実践者の事例、新しい活用法を共有するコミュニティです。<br><br>最初のはずみ車を回すところが少し困難かもしれません。でも、回してしまえばその後の回転はとても速い。一緒に回しませんか。</div>
<div class="community-form" id="communityForm">
<div class="form-row">
<input type="text" id="comName" placeholder="氏名">
<input type="text" id="comOrg" placeholder="所属（任意）">
</div>
<input type="email" id="comEmail" placeholder="メールアドレス">
<label class="form-consent"><input type="checkbox" id="comConsent"> コミュニティからのメールマガジン配信に同意します。配信はいつでも停止できます。</label>
<button class="community-submit" onclick="submitCommunity()" id="comSubmit">コミュニティに参加する</button>
</div>
<div class="community-success" id="communitySuccess">
<h4>ご参加ありがとうございます</h4>
<p>今後、コミュニティの最新情報をお届けします。<br>一緒に未来を作っていきましょう。</p>
</div>
</div>
`
        }
...
<div class="community-lead">このマニュアルを読み終えた今、あなたは「最初のはずみ車を回す」準備ができています。しかし一人で回すより、実践者たちと学び合いながら回すほうが、はずみ車の回転ははるかに速くなります。<br><br>マニュアルの更新、新しい実践事例、AI協働の最新動向を共有するコミュニティに参加しませんか。</div>
<div class="community-form" id="communityForm2">
<div class="form-row">
<input type="text" id="comName2" placeholder="氏名">
<input type="text" id="comOrg2" placeholder="所属（任意）">
</div>
<input type="email" id="comEmail2" placeholder="メールアドレス">
<label class="form-consent"><input type="checkbox" id="comConsent2"> コミュニティからのメールマガジン配信に同意します。配信はいつでも停止できます。</label>
<button class="community-submit" onclick="submitCommunity2()" id="comSubmit2">コミュニティに参加する</button>
</div>
