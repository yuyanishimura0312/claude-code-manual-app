...
<span class="community-label">LIVING FUTURES NETWORK</span>
<h3>共に学ぶ機会に参加する</h3>
</div>
<div class="community-quote">AIとの協働で「まだ形になっていない未来」を作る。その実践を、共に学びながら進める場です。</div>
<div class="community-lead">マニュアルの更新情報、実践者の事例、<br>AI協働の最新動向を共有します。</div>
...
<label class="com-label">メールマガジンに登録する</label>
</div>
...
<button class="com-btn com-btn-primary" onclick="submitCommunity()" id="comSubmit">登録する</button>
</div>
</div>
...
<div class="community-quote">AIとの協働で「まだ形になっていない未来」を作る。はずみ車は、一人で回すより一緒に回すほうが速い。</div>
<div class="community-lead">マニュアルの更新情報、実践者の事例、<br>AI協働の最新動向を共有します。</div>
<div class="community-divider"></div>
...
<button class="com-btn com-btn-primary" onclick="submitCommunity2()" id="comSubmit2">登録する</button>
</div>
</div>
